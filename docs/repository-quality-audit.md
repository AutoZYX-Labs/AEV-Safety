...
2. Hero 中给出中文全称和英文全称。
3. 简介突出开放安全保证、测试评价、标准化、自主性和自动驾驶相关能力。
4. 页面包含框架、场景、标准、成果和文档五类导航。
5. 成果路线明确安全开发实践、工程产品落地、论文与综述沉淀、标准化预研包四条线。
6. 公开文档库链接到中英文配对文件。
...
1. 安全开发实践：把 MWMS、WTDC、DMWT、预期功能安全风险链、测试记录、运行监控和安全案例转为工程工作流。
2. 工程产品落地：支撑装载机、挖掘机、矿卡、打桩/开沟设备和施工机器人试点中的运行边界、任务质量、异常恢复和产品证据。
3. 论文与综述沉淀：中文综述论文和英文方法论文用于建立共同语言并接受同行审阅。
4. 标准化预研包：优先形成测试评价与运行监控要求，兼顾预期功能安全实施指南、WTDC、DMWT 和安全案例指南。
5. 技术工作包：把来源、技术对象、验证方式、证据边界和后续工作拆为 WP0-WP6。
