...
4. SOTIF 必须使用 Safety of the Intended Functionality / 预期功能安全，不出现错误英译。
...
| 术语 | 使用方式 |
|---|---|
| SOTIF | 保留英文缩写，首次出现时按语境说明为 Safety of the Intended Functionality / 预期功能安全 |
...
3. 标准化预研包：优先形成测试评价与运行监控要求，兼顾 SOTIF 实施指南、WTDC、DMWT 和 safety case 指南。
...
3. 为 RESS 英文方法论文补充至少 3 个 worked examples。
4. 把测试记录字段逐步转为可机读模板。
5. 准备团体标准预研材料和专家讨论版。
