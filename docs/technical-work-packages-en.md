...
| Construction and mining autonomy literature | Semi-automated sites, cooperating equipment, System of Systems (SoS) safety and remote supervision | Literature review, architecture, standards roadmap | Project-specific hazard analysis and field tests |
